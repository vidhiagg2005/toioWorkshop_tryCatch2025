/*
 * ToioTeachingSandbox_IfElseOnly.cs
 *
 * Focus: Learning how to use conditions with if / else statements.
 * Students edit only the marked section to decide how their robot should react.
...
public class ToioTeachingSandbox_IfElseOnly : MonoBehaviour
{
    [Header("Connection")]
    ...
    async void Start()
    {
        ...
        Debug.Log("[IfElseSandbox] Scanning... press cube buttons to wake them.");
        ...
        if (cubes.Length == 0)
        {
            Debug.LogError("[IfElseSandbox] No cubes connected.");
            enabled = false;
            return;
        }

        Debug.Log($"[IfElseSandbox] Connected {cubes.Length} cube(s).");
        ...
        Debug.Log("[IfElseSandbox] Ready to teach IF–ELSE logic!");
    }
    ...
    {
        Debug.Log("[IfElseSandbox] Running student IF–ELSE pattern...");

        // --- START: Students edit below this line ---
        /*
         * 🚀 Your Task:
         * Use an IF / ELSE condition to make your robot react differently 
         * depending on a situation (or a random choice).
         *
         * 💡 Syntax Reminder:
         * if (condition)
         * {
         ...
         * }
         *
         * 🧠 Helper functions you can use inside IF or ELSE:
         *
         * await MoveForwardAsync(c, speed, ms);
         *     → Move forward for a specific time (ms)
         *
         ...
         *
         * await WiggleAsync(c);
         *     → Small left-right wobble motion
         *
         * await NudgeAsync(c);
         *     → Tiny forward and back hop
         *
         * await BeepAsync(c);
        ...
        // Example: Random decision to either spin or wiggle
        bool spin = Random.value > 0.5f;
        ...
        Debug.Log("[IfElseSandbox] Student pattern finished!");
    }
